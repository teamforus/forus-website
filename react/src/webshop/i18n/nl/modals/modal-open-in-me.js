module.exports = {
    ...
    sms: {
        ...
        subdescription_formal:
            'Krijgt u geen sms dan kunt u <i>Me</i> downloaden via de link <strong class="text-strong">www.forus.io/DL</strong> op uw mobiele telefoon.',
        subdescription_informal:
            'Krijg je geen sms dan kun je <i>Me</i> downloaden via de link <strong class="text-strong text-primary">www.forus.io/DL</strong> op je mobiele telefoon.',
        sent: 'Een sms-bericht is verstuurd.',
        sent_description:
            'Heeft u geen bericht ontvangen? Download <i>Me</i> via de link <strong class="text-strong text-primary">www.forus.io/DL</strong> op uw mobiele telefoon.',
        button: {
            send: 'Versturen',
            skip: 'Overslaan',
        },
