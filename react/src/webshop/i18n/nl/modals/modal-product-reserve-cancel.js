module.exports = {
    ...
    description_not_cancelable:
        'Deze reservering is al door de aanbieder geaccepteerd. Neem voor het annuleren binnen 14 dagen na datum van de reservering contact op met de aanbieder.',
    header_pending: {
        title_formal: 'Weet u zeker dat u de reservering wilt annuleren?',
        title_informal: 'Weet je zeker dat je de reservering wilt annuleren?',
    },
    description_pending: {
