module.exports = {
    ...
    header: {
        ...
        subtitle:
            'Welkom op de website van {{fund}}. Heeft u van de gemeente een toekenning voor {{fund}}? Dan kunt u hier het aanbod zien en het geld dat u kunt besteden.',
        subtitle_av:
            'Welkom op de website van de {{fund}}. U kan hier de regeling aanvragen en het aanbod bekijken. Na de aanvraag kunt u ook zien hoeveel geld u kunt besteden.',
        title_multi: 'Webshop {{org_name}}',
        subtitle_multi:
            'Welkom op de webshop van {{org_name}} Heeft u via {{org_name}} een toekenning gekregen? Dan kunt u hier het aanbod zien en het geld dat u kunt besteden.',
        header_note: '',
        ...
        berkelland: {
            ...
            subtitle_multi:
                'Welkom op de website van de Kindregeling van de gemeente Berkelland. Heeft u via Fijnder een toekenning voor de Kindregeling gekregen? Dan kunt u hier het aanbod zien en het geld dat u kunt besteden.',
        ...
        oostgelre: {
            ...
            subtitle_multi:
                'Welkom op de website van de Kindregeling van de gemeente Oost Gelre. Heeft u via Fijnder een toekenning voor de Kindregeling gekregen? Dan kunt u hier het aanbod zien en het geld dat u kunt besteden.',
            cta: 'Klik op ‘Start’ en vul uw activatiecode in. Deze code staat in de brief over de Kindregeling die u heeft ontvangen.',
        },
        winterswijk: {
            title_multi: 'Kindregeling gemeente Winterswijk',
            subtitle_multi:
                'Welkom op de website van de Kindregeling van de gemeente Winterswijk. Heeft u via Fijnder een toekenning voor de Kindregeling gekregen? Dan kunt u hier het aanbod zien en het geld dat u kunt besteden.',
            cta: 'Klik op ‘Start’ en vul uw activatiecode in. Deze code staat in de brief over de Kindregeling die u heeft ontvangen.',
        ...
        noordoostpolder: {
            title: 'Meedoenpakket',
            subtitle:
                'Welkom op de website voor het Meedoenpakket van de gemeente Noordoostpolder. Hier kunt u zien hoe hoog uw Meedoen tegoed is en waar u het aan kunt besteden.',
    ...
    faq: {
        ...
        thirteen:
            'Nee, het tegoed is strikt persoonlijk. U mag het tegoed niet aan iemand anders geven. Maakt iemand anders wel gebruik van uw tegoed dan wordt uw eigen bedrag lager.',
        ...
        berkelland: {
            ...
            one: "Klik rechts bovenaan op 'Start'. Vul uw e-mailadres en de activatiecode (8 tekens) in die u per brief heeft ontvangen. Klik vervolgens op 'Versturen'. Uw profiel is aangemaakt en uw tegoed is geactiveerd!",
            faq_two: 'Hoe kan ik inloggen op de webshop?',
            two: "Dit kan op meerdere manieren, de makkelijkste is per e-mail. Klik rechts bovenaan op 'Inloggen'. Kies voor 'Log in via e-mail'. Vul het e-mailadres in die u ook tijdens de activatie hebt gebruikt en klik op 'Versturen'. Open de e-mail en klik op de link die u heeft ontvangen om in te loggen.",
            faq_three: 'Bij welke aanbieders kan ik {{fund}} besteden?',
            three: "U kan een overzicht van alle aanbieders terugvinden op de webshop. Ga naar 'Overzicht van alle aanbieders'",
            ...
            eleven: 'Ja, dat kan. Neem dan contact op met Fijnder, 0544-474200.',
            faq_twelve:
                'Hoe kom ik in aanmerking voor de Kindregelingen en/of het Meedoenarrangement voor volwassenen?',
            twelve:
                'Als u denkt recht te hebben op een Kindregeling, neem dan contact op met Fijnder, 0544-474200. Zij bekijken of u voldoet aan de voorwaarden. <br>' +
            ...
            faq_fifteen: 'Welke organisaties kunnen mij ook ondersteuning bieden?',
            fifteen:
                "Voor vragen over welzijn, gezondheid, wonen, zorg, werk, meedoen en geldzaken kunt u ook terecht op <a target='_blank' href='https://www.berkellandwijzer.nl'>www.berkellandwijzer.nl</a> <br> Voor vragen over o.a. inkomensondersteuning, kunt u terecht bij Fijnder.",
        },
    },
    guide: {
        title: 'Hoe het werkt',
