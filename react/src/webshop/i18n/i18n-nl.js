...
export default {
    ...
    page_state_loading_titles: {
        home: 'Webshop{{wcagSuffix}}',
        fund: 'Fund{{wcagSuffix}}',
        reimbursement: 'Declaratie{{wcagSuffix}}',
        'reimbursement-edit': 'Kosten terugvragen bewerk',
        product: 'Aanbod',
        products: 'Aanbod{{wcagSuffix}}',
    ...
    page_state_titles: {
        ...
        funds: 'Aanvragen{{wcagSuffix}}',
        reimbursements: 'Declaraties{{wcagSuffix}}',
        reimbursement: 'Declaratie - {{code}}{{wcagSuffix}}',
        ...
        'products-show': 'Aanbieding{{wcagSuffix}}',
        'products-apply': 'Aanbieding kopen{{wcagSuffix}}',
        vouchers: 'Mijn tegoed{{wcagSuffix}}',
        voucher: 'Uw tegoed - {{address}}{{wcagSuffix}}',
        reservations: 'Reserveringen{{wcagSuffix}}',
        provider: 'Aanbieder - {{provider_name}}',
        records: 'Persoonsgegevens',
        explanation: 'Uitleg aanvragen vergoedingen{{wcagSuffix}}',
        ...
        'search-result': 'Zoekresultaten for search results{{wcagSuffix}}',
    ...
    custom_page_state_titles: {
        vergoedingen: {
            funds: 'Alle vergoedingen{{wcagSuffix}}',
            fund: '{{fund_name}}{{wcagSuffix}}',
        },
    },
    implementation_name: {
        general: 'General',
